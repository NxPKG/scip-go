...
//  ^^^^^^^^^^^^^^^^^^^^^^^^^^^ reference github.com/nxpkg/gologin c6f1b62954d8 `github.com/dghubble/gologin`/
  )
...
//             ^^^^^^^ reference github.com/nxpkg/gologin c6f1b62954d8 `github.com/dghubble/gologin`/
//                     ^^^^^^^^^^^^^^^^^^^ reference github.com/nxpkg/gologin c6f1b62954d8 `github.com/dghubble/gologin`/DefaultCookieConfig.
  }
